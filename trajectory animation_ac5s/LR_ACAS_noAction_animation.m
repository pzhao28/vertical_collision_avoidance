...
D=trajectory3([ac1{1},ac2{1},ac3{1},ac4{1},ac5{1}],[ac1{2},ac2{2},ac3{2},ac4{2},ac5{2}],200*ones(200,5),zeros(200,5),zeros(200,5),[zeros(200,1) -0.1*pi*ones(200,1),0.3*pi*ones(200,1),0.7*pi*ones(200,1),1.1*pi*ones(200,1)],0.05,1,'747');
