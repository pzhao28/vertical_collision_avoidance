    ...
    for beta in range(120, 720, 120):
        ...
        while step < num_iteration:
            ...
            for key in order:
                ...
                if step == 0:
                    cst_map = world.cost_map(key, order, all_ac, T_to_hit, beta/2)
                else:
                ...
                if step == num_iteration - 1:
                    axs[i].plot((trvl_plan - start_state[0]) * height_range[2] * 50 / 6, label = r'$\beta$={}'.format(beta))
