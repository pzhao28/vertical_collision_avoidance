    ...
    while step < num_iteration:
        ...
        for key in order:
            ...
            if step == num_iteration - 1:
                ...
                axs[i, 0].set_title('Cost Map of Aircraft {}'.format(name_ac[i]))
                ...
                axs[i, 1].set_title('Path Planning of Aircraft {}'.format(name_ac[i]))
                axs[i, 1].set_xlabel('Time(s)')
                axs[i, 1].set_ylabel('Relative height(ft)')
                axs[i, 1].set_ylim(-2500, 2500)
                i += 1
...
T_to_hit = {'ac1':[np.inf, 0, 100, 100, 100],'ac2':[0, np.inf, 100, 100, 100], 'ac3':[100, 100, np.inf, 0, 0], 'ac4':[100, 100, 0, np.inf, 0], 'ac5':[100, 100, 0, 0, np.inf]}
num_ac = 3
interval = 200
...
ac = Aircraft(0, 0)
start_ac1 = int(500 * 6/50 - height_range[0])
start_ac2 = int(-500 * 6/50 - height_range[0])
start_ac3 = int(1000 * 6/50 - height_range[0])
start_ac4 = int(0 * 6/50 - height_range[0])
start_ac5 = int(-1000 * 6/50 - height_range[0])
...
ac4 = ac.set_ac('ac4', start_ac4, 0, np.array([start_ac4]*interval))
ac5 = ac.set_ac('ac5', start_ac5, 0, np.array([start_ac5]*interval))
...
order = ['ac1', 'ac2', 'ac4'] #fixed order! Do not change exept adding or deleting.
order_num = ['ac1', 'ac2', 'ac3', 'ac4', 'ac5']
num_ac = len(order)
name_ac = ['A', 'B', 'C']
