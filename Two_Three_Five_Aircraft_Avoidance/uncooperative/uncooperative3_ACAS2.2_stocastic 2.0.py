...
'''def init_sort():
    init_cost_dic = dict()                axs[i, 1].set_ylim(-2000, 2000)
...
T_to_hit_ac1 = {'ac1':[np.inf, 0, 100, 100, 100],'ac2':[0, np.inf, 100, 100, 100], 'ac3':[100, 100, np.inf, 0, 0], 'ac4':[100, 100, 0, np.inf, 0], 'ac5':[100, 100, 0, 0, np.inf]}
T_to_hit_ac2 = {'ac1':[np.inf, 0, 100, 100, 100]}
T_to_hit_ac3 = {'ac2':[0, np.inf, 100, 100, 100]}
T_to_hit_ac
